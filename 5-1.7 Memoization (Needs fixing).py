...
# -----------------------------------------------------------------------------
# This is actually wrong, even though it works.  The key stored in the cache
# should be the fucntion's input, not the fuction itself - or perhaps - each
# function should be a key who's value is another dictionary of input keys and 
# output values for that function.
# -----------------------------------------------------------------------------
